...
path = "/home"
csvpath = os.path.join(path, "C:/Users/Laura/Desktop/budget_data.csv")
...
# I programmed this with the files being located on my desktop,
print_txt = os.path.join(os.path.expanduser("~"), "Desktop", "bank_summary.txt")
...
with open(print_txt,"w") as file:
    ...
    file.write(f"Greatest Increase in Profits: {months[greatest_increase]} (${(str(greatest_increase))}) \n")
    file.write(f"Greatest Decrease in Profits: {months[greatest_decrease]} (${(str(greatest_decrease))}) \n")